...
import AbbasidPalaceExploration from "../zainabsours/imges/AbbasidPalaceExploration.webp";
import ZigguratofUrMarshlands from "../zainabsours/imges/ZigguratofUrMarshlands.webp"; // أضف صورة هنا
...
const Card = () => {
  ...
  const tours = [
    {
      title: "Abbasid Palace Exploration",
      image: AbbasidPalaceExploration,
      destination: "Baghdad, Abbasid Palace",
      duration: "1 day",
      departureDates: "Weekly (Fridays)",
      price: "$150",
      includes: "Guide, Transport",
    },
    {
      title: "Ziggurat of Ur & Marshlands",
      image: ZigguratofUrMarshlands,
      destination: "Ziggurat of Ur, Marshes",
      duration: "3 days",
      departureDates: "First weekend of each month",
      price: "$500",
      includes: "Guide, Accommodation, Boat Rides",
    },
    {
      title: "Samarra Minaret Experience",
      image: AncientBabylon,
      destination: "Samarra Minaret, Abbasid sites",
      duration: "2 days",
