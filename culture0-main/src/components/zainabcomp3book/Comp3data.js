    ...
    return(
     <div className="Datacomp">
         ...
         <div className="compnname">
             <h1>Aknaf Al-Sawary</h1>
             <p className="p">Aknaf Al-Sawary is a Baghdad-based travel company offering specialized religious and historical tours, covering sacred sites and ancient wonders across Iraq. Their packages provide in-depth exploration of Iraq’s rich heritage.</p>
         </div>
         ...
         <div className="socal">
             <div class="socalcard">
                <a class="socialContainer containerOne" href="https://www.instagram.com/aknaf_tours/ ">
                ...
                <a class="socialContainer containerFour" href="https://www.facebook.com/aknafalsawaryEN/">
         ...
         <img className="comp01" src={complogo3} width="290%" height="90%" />
         </div>
