...
function Datacomp() {
    ...
    return(
     <div className="Datacomp">
         ...
         <h1>Rocky Road Travel</h1>
             <p className="p">Rocky Road Travel provides extensive small-group tours focusing on historical and religious sites, including Ziggurat of Ur, Karbala, and Babylon, offering deep cultural insights.</p>
         </div>
         ...
         <img className="comp01" src={complogo} width="60%" height="75%" />
         </div>
